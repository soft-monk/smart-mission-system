...
│  └─ src/{api,ws,stores,app}
├─ map-2d/                   # ★ 二维地图绘制模块（独立可运行 / 可整包交付 / 可独立子仓）
│  ├─ src/{core,primitives,render,ui,standalone}
...
| **地图相关需求专篇** | docs/02-技术需求/ | **地图需求单一入口**：条目总表、图层清单、分阶段地图矩阵、全屏态势图、验收清单 |
